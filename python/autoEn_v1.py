...
def encoder():
    model = Sequential()
    model.add(Dense(45, input_dim=input_size, activation='tanh', bias=True))
    model.add(Dense(23, activation='tanh', bias=True))
    model.add(Dense(17, activation='tanh', bias=True))
    return model

def decoder(e):   
    e.add(Dense(23, input_dim=17, activation='tanh', bias=True))
    e.add(Dense(45, activation='tanh', bias=True))
