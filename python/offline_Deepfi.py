...
for n in range(17):
    ...
    def encoder():
        ...
        model.add(Dense(18, activation='tanh', bias=True, name="K3"))
        model.add(Dense(10, activation='tanh', bias=True, name="K4"))
        model.compile(optimizer='adam', loss='mse')
        return model
    
    def decoder(e):   
        e.add(Dense(18, input_dim=15, activation='tanh', bias=True, name="K3_"))
        e.add(Dense(23, activation='tanh', bias=True, name="K2_"))
