...
%        k=randi([1, 19])
       ...
       csi_trace= read_bf_file(strcat('my_data/420-part2/LOC',num2str(k),'/loc',num2str(k),'_1','/',files(j).name));
      ...
      movefile(strcat('csi','_loc_',num2str(k),'_',num2str(j),'.mat'),'C:\Users\zevik\Desktop\New folder\420')
      end
